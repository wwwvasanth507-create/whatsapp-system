...
interface LocalChatRepository {
    ...
    suspend fun getConversation(recipientUserId: String, recipientDeviceId: String): ConversationEntity?
    suspend fun saveConversation(conversation: ConversationEntity)
    
    fun getMessagesForConversation(recipientUserId: String, recipientDeviceId: String): Flow<List<MessageEntity>>
